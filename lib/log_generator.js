...
module.exports=send=function(request,event){
...
logging.info(log(clientId=clientIp, ip=ipAddress, userAgent=userAgent, timestamp=str(datetime.utcnow())));//ApplicationName=plugin_name, data=(internal_data)))
